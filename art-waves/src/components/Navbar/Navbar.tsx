        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:flex sm:items-center sm:space-x-8">
              <Link
                to="/"
                className="text-gray-600 hover:text-indigo-600 px-3 py-2 rounded-md transition duration-150"
              >
                Home
              </Link>
              <Link
            ...
            <div className="hidden sm:flex sm:items-center sm:space-x-4">
              <Link
                to="/wishlist"
                className="text-gray-600 hover:text-indigo-600 p-2 rounded-full transition duration-150 relative"
              >
